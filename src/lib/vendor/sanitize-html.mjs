/* GENERATED — do not edit. `npm run vendor:sanitizer`.
   Bundled from sanitize-html@2.17.7; see scripts/vendor-sanitizer.mjs. */
export const SANITIZE_HTML_VERSION = "2.17.7";
...
var export_default = import_sanitize_html.default;
export {
